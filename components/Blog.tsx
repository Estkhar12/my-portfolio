                    ...
                    <li className="blog-post-item">
                        <a href="#">
                            ...
                            <div className="blog-content">
                                ...
                                <p className="blog-text">
                                    Sed ut perspiciatis, nam libero tempore, cum
                        ...
                        <a href="#">
                            ...
                            <div className="blog-content">
                                ...
                                <p className="blog-text">
                                    ...
                                    proident, quis nostrum exercitationem ullam
                                    corporis suscipit.
                                </p>
                            </div>
                        </a>
                    ...
                    <li className="blog-post-item">
                        <a href="#">
                            ...
                            <div className="blog-content">
                                ...
                                <p className="blog-text">
                                    Enim ad minim veniam, consectetur adipiscing
                    ...
                    <li className="blog-post-item">
                        <a href="#">
                            ...
                            <div className="blog-content">
                                ...
                                <p className="blog-text">
                                    Optio cumque nihil impedit uo minus quod
